...
public class MercenaryClothingLayer extends RenderLayer<MercenaryEntity, PlayerModel<MercenaryEntity>> {
    private final PlayerModel<MercenaryEntity> model;

    public MercenaryClothingLayer(RenderLayerParent<MercenaryEntity, PlayerModel<MercenaryEntity>> parent) {
        super(parent);
        ModelPart part = LayerDefinition.create(PlayerModel.createMesh(new CubeDeformation(0.0625F), false), 64, 64).bakeRoot();
    ...
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight, MercenaryEntity entity,
        ...
        ResourceLocation texture = WardrobeManager.getMercenaryClothingTexture(entity);
